...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveValidateApiClient.GeolocateResponse();
  });
  ...
  describe('GeolocateResponse', function() {
    it('should create an instance of GeolocateResponse', function() {
      // uncomment below and update the code to test GeolocateResponse
      //var instane = new CloudmersiveValidateApiClient.GeolocateResponse();
      //expect(instance).to.be.a(CloudmersiveValidateApiClient.GeolocateResponse);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveNlpApiClient.PosResponse();
  });
  ...
  describe('PosResponse', function() {
    it('should create an instance of PosResponse', function() {
      ...
      //var instane = new CloudmersiveNlpApiClient.PosResponse();
      //expect(instance).to.be.a(CloudmersiveNlpApiClient.PosResponse);
    });

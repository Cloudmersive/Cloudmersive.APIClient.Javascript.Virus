...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveNlpApiClient.WordPosition();
  });
  ...
  describe('WordPosition', function() {
    it('should create an instance of WordPosition', function() {
      // uncomment below and update the code to test WordPosition
      //var instane = new CloudmersiveNlpApiClient.WordPosition();
      //expect(instance).to.be.a(CloudmersiveNlpApiClient.WordPosition);
    });

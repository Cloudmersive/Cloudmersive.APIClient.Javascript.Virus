...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveNlpApiClient.PosTaggerJsonApi = factory(root.CloudmersiveNlpApiClient.ApiClient, root.CloudmersiveNlpApiClient.PosRequest, root.CloudmersiveNlpApiClient.PosResponse);
  }
   ...
   * @alias module:api/PosTaggerJsonApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/PosTaggerJsonApi~posTaggerJsonPostCallback
     ...
     * @param {module:api/PosTaggerJsonApi~posTaggerJsonPostCallback} callback The callback function, accepting three arguments: error, data, response
